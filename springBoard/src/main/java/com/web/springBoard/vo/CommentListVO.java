...
public class CommentListVO {
	...
	public void initCommentList(int pageSize, int totalCount, int currentPage) {
	...
	public String toString() {
		return "CommentListVO [commentList=" + commentList + ", pageSize=" + pageSize + ", totalCount=" + totalCount
